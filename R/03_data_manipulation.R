...
# Now, we want to transform our species vs. area on a worksheet that contains
# each __observation__ in a __row__ and each __variable__ in a __column__.
# Each observation is the abundance of a species in a given area.
# To do this transformation we will use the `gather()` function
# from the __tidyr__ package. As we have 97 sites and 56 species, we will end up
# with an object with 5432 lines (97 x 56).
# OU SEJA, vamos tornar os dados "more tidier"
